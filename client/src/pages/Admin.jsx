  ...
  return (
    <section>
      ...
      <div className='flex flex-col items-center gap-8 md:flex-row'>
        <div className='bg-[#f2f2f2] rounded shadow flex flex-col justify-center items-center w-full md:w-52 p-8 lg:w-72 mt-6 md:mt-8'>
          <p>
            <FaUserCircle className='mb-4 h-8 w-8 md:h-10 md:w-10 lg:h-12 lg:w-12' />
          </p>
          <h4>{`total users: ${users}`}</h4>
        </div>
        <div className='bg-[#f2f2f2] rounded shadow flex flex-col justify-center items-center w-full md:w-52 p-8 lg:w-72 mt-0 md:mt-8'>
          <p>
